...
variable "vpc_hub_name_2" {
 ...
 variable "address_vpc_hub_2_1" {
   description = "Adress prefix for VPC HUB 2 in zone 1"
   type        = string
   default     = "193.168.192.0/20"
 }

 variable "address_vpc_hub_2_2" {
   description = "Adress prefix for VPC HUB 2 in zone 2"
   type        = string
